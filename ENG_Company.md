GCI World 2026 Spring Company A Dataset Overview

## 1\. About the dataset

A folder named **telecom**, which contains historical data from Company A (an anonymous telecommunications service provider), is provided.

- Dataset details
  - It contains two types of .csv files with the following information:
    - Customer information（Client）
    - Usage history（Record）
  - It is a large-scale table data of approximately 100,000 records × -100 columns

## 2\. Where to start

- Inspect the database on your own
- Analyze the data using the necessary Python modules (e.g., pandas)

## 3\. Column Descriptions

When we inquired about the data from Company A's representative, we received the following explanation for some of the columns. As of now, no formal consulting contract has been signed, and due to Company I's strict data protection policies, no further details will be disclosed. Some aspects of the dataset may remain unclear. However, handling ambiguity is an essential part of real-world business analysis, so proceed with your analysis under these given constraints.

| Column Name      | Explanation of the Content                                                  |
| ---------------- | --------------------------------------------------------------------------- |
